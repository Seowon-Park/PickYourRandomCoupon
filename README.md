...
### 일정
**아이디어 구체화** 2025.04.08(1시간)<br/>
**데이터 구조 및 흐름 파악** 2025.04.09(1시간)<br/>
**제작**<br/>
쿠폰 덱 완성 및 셔플<br/>
사용자 pick 쿠폰<br/>
뽑은 쿠폰을 사용자에게 저장<br/>
|시간|작성 내용|추가 및 수정사항/문제점| 
|:2025.04.08(1시간)|:아이디어 구체화||
|:2025.04.08(1시간)|:데이터 구조, 흐름 파악||
|:2025.04.09(1시간)|:카드/카드덱(뽑기, 셔플 기능)/메인(게임시작->도전/만족 선택->쿠폰종류(전자기기,식품,화장품)선택=>결과프린트)|5~8번 기능 추가해야함. 너무 순차적으로 작성한 듯.. 객체지향적으로 작성해보기|
